...
int main() {
    ...
    while(life > 0) { 
        ...
        if (command == 'b') {
            ...
            for (g = 0; g < 9; g++) {
                for (j = 0; j < 9; j++) {
                    if (left == 0 && game_board[g][j].bug == 1) {
                        if (j + game_board[g][j].bug_dir >= 0 && j + game_board[g][j].bug_dir < 9 && game_board[g][j+1].type == LOG) { // log to the right
                    ...
                    else if (left == 1 && game_board[g][j].bug == 1) {
                        if (j + game_board[g][j].bug_dir >= 0 && j + game_board[g][j].bug_dir < 9 && game_board[g][j-1].type == LOG) {                
                            game_board[g][j].bug_dir = -1;
                            game_board[g][j].bug = 0;
                            game_board[g][j + game_board[g][j].bug_dir].bug = 1;                                                                                          
                        } 
